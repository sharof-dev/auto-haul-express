      ...
      <CircleContainer sx={{ mt: 30 }}>
        ...
        >
          <Typography variant="body1" style={{ color: '#0D1B2A' }}>
            Get an instant quote for our top-notch vehicle shipping services, providing hassle-free and efficient transport with a focus on affordability, safety, reliability, and competitive pricing.
          </Typography>
        </Box>
      </CircleContainer>
    </Container>
